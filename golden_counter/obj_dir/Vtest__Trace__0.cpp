...
void Vtest___024root__trace_chg_0_sub_0(Vtest___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgBit(oldp+0,(vlSelf->test__DOT__clk));
    bufp->chgBit(oldp+1,(vlSelf->test__DOT__rst_n));
    bufp->chgBit(oldp+2,(vlSelf->test__DOT__en));
    bufp->chgCData(oldp+3,(vlSelf->test__DOT__count),4);
}
